 ...
 * Input JSON: {"path": "<ESPAGENT_SPIFFS_BASE>/...", "old_string": "...", "new_string": "..."}
 */
 ...
 * Input JSON: {"prefix": "<ESPAGENT_SPIFFS_BASE>/..."} (prefix is optional)
 */
